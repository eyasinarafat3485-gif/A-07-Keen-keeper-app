    ...
    return (
        <div className="bg-slate-50 min-h-screen p-8 font-sans py-15">
            <div className="text-center w-[85%] mx-auto">
                ...
                <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-md flex items-center gap-2 mx-auto transition-colors duration-200 font-medium">
                    <FaPlus />
                ...
                <div className="mt-16 border-t border-slate-200 w-full"></div>
            </div>
        </div>
    );
};
